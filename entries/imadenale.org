...
#+link: files https://raw.githubusercontent.com/takaxp/takaxp.github.io/master/f0iles
...
:EXPORT_HUGO_TAGS: "photo" "EOS" "M200"
:EXPORT_HUGO_LASTMOD: 
:EXPORT_HUGO_IMAGES: 
...
** DONE Shadow                                                       :@photo:
   CLOSED: [2021-04-10 Sat 19:12]
:PROPERTIES:
:EXPORT_FILE_NAME: 0410-shadow-on-wall
:EXPORT_HUGO_TAGS: "photo"
:EXPORT_HUGO_LASTMOD: 
:EXPORT_HUGO_IMAGES: https://pxaka.tokyo/nextcloud/index.php/apps/files_sharing/publicpreview/AJgGq68ATmYM76P?x=1024&y=1024&a=true&file=IMG_0313.jpg
:ID:       C984B080-2C86-4460-ABE6-81A4E78D4814
:CREATED:  [2021-04-10 Sat 19:10]
:END:

{{< photo AJgGq68ATmYM76P >}}
** DONE マッシュルームのパスタ                                     :@cooking:
   CLOSED: [2021-04-03 Sat 21:09]
:PROPERTIES:
:EXPORT_FILE_NAME: 0403-pasta-mushroom
:EXPORT_HUGO_TAGS: "pasta" "tomato"
:EXPORT_HUGO_LASTMOD: 
:EXPORT_HUGO_IMAGES: 
:ID:       6C7B5861-DD6D-47A1-845A-BA14A97265FB
:CREATED:  [2021-04-12 Mon 21:03]
:END:
...
年明けにEOS M200を購入してから，ここまでの使用感です．結論として「購入して大正解!!」です．

*** 軽くて小さい

昔使っていたアナログ一眼レフとの比較で言うと，まず「本体がかなり軽い」ですね．

そして小さい．これはミラーレスになったのが主要因だと思いますけど，持ち運びに対する抵抗感がほぼ無いので，ちょっとした外出時にも「とりあえず持っていくかかな」と思わせてくれます．

本体が小さいと，グリップ感が失われて逆に手ブレが気になりますが，「デュアルセンシングIS」のおかげか，手ブレに関してはそれほど気にしなくて良いかなと思います．全く気にならないというよりかは，露出やシャッターの選択度が増したと言えますね．

本体のデザインがかなりシンプルなので，グリップ部分が無く，しかも，ファインダーも無いので，撮影のスタイルがアナログ一眼レフと全く異なりますね．むしろ潔くて良いと思います．

*** 画像共有が楽

アナログ一眼と並行していわゆるコンデジも使ってきましたが，最大の面倒は，撮影データの扱いでした．撮影した画像が記録されたメモリカードを毎度本体から取り出し，アダプタを経由して mac に接続してインポート．そしてメモリカードを本体に戻す．面倒でした．

EOS M200に限らず，最近のカメラは外部と通信するために WiFi や Bluetooth に対応していますね．スマホの便利さ（撮影したらすぐに共有）に近づいています．

画像の共有にはいくつかの選択肢がありますが，私はとりあえず次のようなフローにしました．

1. =image.canon= 経由で =Google Photo= に画像を保存できる
2. Downloader for image.canonn で自動ダウンロード
3. 
4. 

ただネットワーク経由での共有は，ファイル転送にそれなりの時間を要します．大量のファイル，しかもRAWファイルも同時に撮影している場合は，やはりメモリカードを本体に接続する方が利便性が高いと言えます．今のところは，撮影したらこまめにアップロードすることで，問題ない感じです．
...
ただどちらかといえば，まだまだ使い始めでわかっていないことが多いだけの気もします．設定項目も色々とあるので，使い込んでいくうちに好みの状態に変えていこうと思います．
...
** DONE ベーコンと生姜のパスタ                                     :@cooking:
   CLOSED: [2021-04-13 Tue 19:49]
:PROPERTIES:
:EXPORT_FILE_NAME: 0413-pasta-bacon-ginger
:EXPORT_HUGO_TAGS: "pasta" "salt"
:EXPORT_HUGO_LASTMOD: 
:EXPORT_HUGO_IMAGES: 
:ID:       15A0DF7E-8707-42D7-B810-FEECB67DE61E
:CREATED:  [2021-04-13 Tue 19:46]
:END:
...
| パルメジャーノ | 適量 |      |
| パスタ         |  180 | [g]  |
** DONE 生姜のパスタ(3)                                            :@cooking:
   CLOSED: [2021-04-14 Wed 22:59]
:PROPERTIES:
:EXPORT_FILE_NAME: 0414-pasta-ginger
:EXPORT_HUGO_TAGS: "pasta" "wafu"
:EXPORT_HUGO_LASTMOD: 
:EXPORT_HUGO_IMAGES: 
:ID:       24591588-C55A-4AE5-9D79-3D1994002367
:CREATED:  [2021-04-14 Wed 22:56]
:END:
...
| 茹で汁(1.1%)   |   10 | [cc] |
| パスタ         |  180 | [g]  |
** DONE view-modeをorgバッファで違和感なく使う設定                   :@emacs:
   CLOSED: [2021-04-15 Thu 21:50]
:PROPERTIES:
:EXPORT_FILE_NAME: 0415-org-and-view-mode
:EXPORT_HUGO_TAGS: "emacs" "org-mode" "view-mode"
:EXPORT_HUGO_LASTMOD: [2021-04-17 Sat 23:10]
:EXPORT_HUGO_IMAGES: 
:ID:       DD1B857B-F578-4DD9-AE0A-6324173F63D2
:CREATED:  [2021-04-15 Thu 21:41]
:END:
...
なお、特定のファイルや特定のディレクトリ以下にあるファイルを自動的に ~view-mode~ で開く設定は、[[https://takaxp.github.io/init.html#org6b6c1c11][5.24 viewモード]]を参照してください。

*** References
 - [[https://takaxp.github.io/init.html#org6b6c1c11][5.24 viewモード]]
** DONE all-the-icons から解脱したい                                 :@emacs:
   CLOSED: [2021-04-17 Sat 15:30]
:PROPERTIES:
:EXPORT_FILE_NAME: 0417-emacs-icons-in-terminal
:EXPORT_HUGO_TAGS: "emacs" "all-the-icons" "icons-in-terminal"
:EXPORT_HUGO_LASTMOD: [2021-04-25 Sun 20:20]
:EXPORT_HUGO_IMAGES: 
:ID:       F9A9B280-7479-4CB6-81FE-C91ADF7086E1
:CREATED:  [2021-04-17 Sat 15:12]
:END:
...
*** Update (2021-04-25@20:20)

今回の修正が無事にマージされました。

 - https://github.com/seagle0128/icons-in-terminal.el/pull/3

** DONE レンズを2本追加しました                                      :@photo:
   CLOSED: [2021-04-20 Tue 19:34]
:PROPERTIES:
:EXPORT_FILE_NAME: 0420-additional-ef-m-lenses
:EXPORT_HUGO_TAGS: "photo" "M200"
:EXPORT_HUGO_LASTMOD: 
:EXPORT_HUGO_IMAGES: 
:ID:       7FED6961-3ABC-4F7F-988A-082AB37723E2
:CREATED:  [2021-04-20 Tue 19:15]
:END:
...
{{< tweet 1370687471340511232 >}}
 ...
 - [[https://cweb.canon.jp/ef/lineup/ef-m/ef-m55-200-f45-63-is-stm/][EF-M55-200mm F4.5-6.3 IS STM]]
 - [[https://cweb.canon.jp/ef/lineup/ef-m/ef-m28-f35-is-stm/][EF-M28mm F3.5 マクロ IS STM]]
